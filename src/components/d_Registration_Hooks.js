...
function Registration() {
    ...
    const handleSubmit = (evt) => {
        ...
        sessionStorage.setItem("DesignerName",ename)
        sessionStorage.setItem("DesignerAddress",eaddress)
        sessionStorage.setItem("DesignerPhone",emobile)
        sessionStorage.setItem("DesignerEmailId",eemail)
        ...
        axios.post('http://localhost:4500/deg/regpasswordencrypt/designer', empinfo)
            .then(res => {
