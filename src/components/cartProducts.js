...
function CartProduct() {
    ...
    useEffect(() => {
      axios.get('http://localhost:4500/product/carts/mycart/'+useremail)
        .then(response => {
    ...
    function DeleteFromCart(currentrowid,index) {
      ...
      axios.delete('http://localhost:4500/product/cart/removeitem/'+currentrowid).then(
        setEList(tempprolist),
        axios.get('http://localhost:4500/product/carts/mycart')
        .then(response => {
    ...
    function RemoveFromCart(currentrowid){
      ...
      axios.get('http://localhost:4500/product/carts/removeone/'+currentrowid).then(() =>{
        axios.get('http://localhost:4500/product/carts/mycart/'+ useremail)
        .then(response => {
